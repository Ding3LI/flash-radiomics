#ifndef FLASH_RADIOMICS_NGTDM_CPU_H
#define FLASH_RADIOMICS_NGTDM_CPU_H
...
#define FLASH_RADIOMICS_NGTDM_VOXEL_FEATURE_COUNT 5

// Compute voxel NGTDM features for a batch of discretized kernel windows.
...
#endif // FLASH_RADIOMICS_NGTDM_CPU_H
