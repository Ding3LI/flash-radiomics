#ifndef FLASH_RADIOMICS_GLRLM_CUDA_H
#define FLASH_RADIOMICS_GLRLM_CUDA_H
...
// CUDA implementation of GLRLM features
...
int flash_radiomics_glrlm_cuda_discretized_voxel_batch(
...
#endif // FLASH_RADIOMICS_GLRLM_CUDA_H
