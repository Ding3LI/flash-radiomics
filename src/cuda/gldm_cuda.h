#ifndef FLASH_RADIOMICS_GLDM_CUDA_H
#define FLASH_RADIOMICS_GLDM_CUDA_H
...
// CUDA implementation of GLDM features
...
int flash_radiomics_gldm_cuda_discretized_voxel_batch(
...
#endif // FLASH_RADIOMICS_GLDM_CUDA_H
