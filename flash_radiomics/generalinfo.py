...
class GeneralInfo:
    ...
    def addStaticElements(self):
        ...
        self.generalInfo[self.generalInfo_prefix + "Versions_PyWavelet"] = (
            pywt.__version__
        )
    ...
    def addImageElements(self, image, prefix="original"):
        ...
        """
        if prefix == "original":
            self.generalInfo[self.generalInfo_prefix + "Image-original_Hash"] = (
                sitk.Hash(image)
            )
            self.generalInfo[
        ...
        self.generalInfo[self.generalInfo_prefix + "Image-" + prefix + "_Size"] = (
            image.GetSize()
        )
    ...
    def addMaskElements(self, image, mask, label, prefix="original"):
        ...
        if prefix == "original":
            self.generalInfo[self.generalInfo_prefix + "Mask-original_Hash"] = (
                sitk.Hash(mask)
            )

        self.generalInfo[self.generalInfo_prefix + "Mask-" + prefix + "_Spacing"] = (
            mask.GetSpacing()
        )
        self.generalInfo[self.generalInfo_prefix + "Mask-" + prefix + "_Size"] = (
            mask.GetSize()
        )
        ...
        self.generalInfo[
            self.generalInfo_prefix + "Mask-" + prefix + "_BoundingBox"
        ] = lssif.GetBoundingBox(int(label))
        self.generalInfo[self.generalInfo_prefix + "Mask-" + prefix + "_VoxelNum"] = (
            lssif.GetNumberOfPixels(int(label))
        )
        ...
        self.generalInfo[self.generalInfo_prefix + "Mask-" + prefix + "_VolumeNum"] = (
            ccif.GetObjectCount()
        )
        ...
        self.generalInfo[
            self.generalInfo_prefix + "Mask-" + prefix + "_CenterOfMassIndex"
        ] = center_index

        self.generalInfo[
            self.generalInfo_prefix + "Mask-" + prefix + "_CenterOfMass"
        ] = mask.TransformContinuousIndexToPhysicalPoint(center_index)
    ...
    def addEnabledImageTypes(self, enabledImageTypes):
        ...
        """
        self.generalInfo[
            self.generalInfo_prefix + "Configuration_EnabledImageTypes"
        ] = enabledImageTypes
